...
namespace ContosoUniversity.DAL
{
    public class SchoolInterceptorLogging : DbCommandInterceptor
    {
        ...
        {
            base.ScalarExecuting(command, interceptionContext); _stopwatch.Restart();
        }
        ...
        {
            base.NonQueryExecuting(command, interceptionContext); _stopwatch.Restart();
        }
        ...
        {
            base.ReaderExecuting(command, interceptionContext); _stopwatch.Restart();
        }
